...
qemu-img create -f raw windowsfx11.img 64G
...
wget -O windowsfx11.iso 'https://onboardcloud.dl.sourceforge.net/project/windowsfxdevil/windowsfx-11.1.1109-plasma-win11-theme.iso'
...
sudo qemu-system-x86_64 \
  ...
  -cpu EPYC \
  -boot order=d \
  -drive file=windowsfx11.iso,media=cdrom \
  -drive file=windowsfx11.img,format=raw,if=virtio \
