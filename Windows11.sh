...
qemu-img create -f raw windows11.img 64G
...
wget -O windows11.iso 'https://app.vagrantup.com/limhoyhin/boxes/SuperliteISO/versions/1.0.0/providers/qemu.box'
...
sudo qemu-system-x86_64 \
  ...
  -drive file=windows11.img,format=raw,if=virtio \
